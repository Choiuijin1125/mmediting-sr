...
class SRAnnotationDataset(BaseSRDataset):
    ...
    def __init__(self,
        ...
        self.custom_ext = str(custom_ext)
    ...
    def load_annotations(self):
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                lq_name = f'{self.filename_tmpl.format(basename)}.jpg'
                data_infos.append(
                    dict(
...
@DATASETS.register_module()
class SRAnnotationAuxDataset(BaseSRDataset):
    """General paired image dataset with an annotation file for image
    restoration.
            ...
            for line in fin:
                ...
                data_infos.append(
                    dict(
                        lq_path=osp.join(self.lq_folder, lq_name),
                        gt_path=osp.join(self.gt_folder, gt_name),
                        aux_path=osp.join(self.lq_folder.replace("jpg", "png"), lq_name.replace("jpg", "png")),
                    ))
        return data_infos    